  ...
  return (
    <dialog className="ticket-dialog" ref={dialogRef} aria-labelledby="ticket-dialog-title" onCancel={(event) => { event.preventDefault(); closeDialog() }} onClose={() => onClose?.()}>
      <form className="ticket-form" onSubmit={handleSubmit}>
        ...
        <p className="ticket-form__privacy">Ao prosseguir, você declara ter lido e estar ciente da nossa <a href="/privacidade" target="_blank" rel="noreferrer">Política de Privacidade</a> e da <a href="/marketing" target="_blank" rel="noreferrer">Política de Comunicações e Marketing</a>.</p>
      </form>
    </dialog>
  )
}

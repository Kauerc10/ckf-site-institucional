  ...
  return (
    <dialog className="ticket-dialog" ref={dialogRef} aria-labelledby="ticket-dialog-title" onCancel={(event) => { event.preventDefault(); closeDialog() }} onClose={() => onClose?.()}>
      <form className="ticket-form" onSubmit={handleSubmit}>
        ...
        <p className="ticket-form__privacy">Ao prosseguir, você declara ter lido e estar ciente e de acordo com a <a href="/privacidade" target="_blank" rel="noreferrer">Política de Privacidade</a>. Seus dados serão usados para responder esta Solicitação e preparar o atendimento ou orçamento.</p>
      </form>
    </dialog>
  )
}

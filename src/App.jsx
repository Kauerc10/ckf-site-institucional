...
export function App() {
  return (
    <main>
      ...
      <section className="cost" id="sobre"><img src="/assets/real/oficina-real.webp" alt="Profissional da CKF trabalhando em uma oficina" loading="lazy" /><div className="section-shell cost__copy"><p className="eyebrow">O impacto da parada</p><h2>Equipamento parado <em>custa alto.</em></h2><p>Cada hora parada é perda de produção, atraso na entrega e desgaste da equipe. Manutenção certa é investimento que volta em produtividade.</p></div></section>
